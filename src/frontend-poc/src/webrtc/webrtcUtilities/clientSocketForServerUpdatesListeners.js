...
const clientSocketForServerUpdatesListeners = (socket, bookingReminderRef, myBookingsRef, myBookings, setMyBookings, allBookings, setAllBookings)=>{
    ...
    socket.on('bookingUpdate',bookingUpdate=>{
        console.log("myBookings before bookingUpdate: " + JSON.stringify(myBookings));
        ...
        setMyBookingsWrapper(setMyBookings, bookingUpdate);
...
function setMyBookingsWrapper(setMyBookings, bookingUpdate) {
