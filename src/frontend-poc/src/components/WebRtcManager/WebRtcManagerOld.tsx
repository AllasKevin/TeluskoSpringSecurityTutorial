...
export class WebRtcManagerOld {
  ...
  static async initCall(
    ...
    >,
    setTypeOfCall: React.Dispatch<React.SetStateAction<string>>,
    typeOfCall: string
  ) {
  ...
  static addIceCandidatesAfterAnswerBeenSet(
   ...
   */
  static async addRecievedOfferAndCreateAnswerAsync(
    peerConnection: RTCPeerConnection | undefined,
    ...
    if (!peerConnection) {
      ...
      return;
    } else if (!answerCreated && callStatus?.videoEnabled) {
